...
module.exports.run = async (bot, message, args) => {
    ...
    if (!url || !searchString) return [message.delete(), utils.timed_msg(utils.cmd_fail(`${message.author}, please tell me a music name or url!`, `${config.prefix}play <music/url>`), 5000)];
    ...
    if (url.match(pl)) {
        ...
        return message.channel.send(`:eye: **${playlist.title}** has been added to queue.`);
    } else {
